...
typedef struct track_s
{
    ...
    unsigned int  audio_bytes;       /* Total number of bytes of audio data */
    ...
    unsigned int a_codech_off;       /* absolut offset of audio codec information */ 
    unsigned int a_codecf_off;       /* absolut offset of audio codec information */ 
